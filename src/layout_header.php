...
<head>
    ...
    <!-- Icons (Material Design or similar via SVG in body, but linking a library helps if needed, strictly simple SVG used here) -->
...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-100 font-sans antialiased pb-20 md:pb-0">
    ...
    <nav
        ...
        <div class="flex items-center space-x-3">
            <div class="w-8 h-8 bg-indigo-600 rounded-lg flex items-center justify-center text-white font-bold">IA</div>
            <span class="text-xl font-bold tracking-tight">IAFinance</span>
        </div>
    ...
    <div class="md:hidden flex bg-white dark:bg-gray-800 shadow-sm p-4 justify-between items-center sticky top-0 z-50">
        <span class="text-lg font-bold">IAFinance</span>
